 ...
 * @since ?
 */
public class RealHttp implements Http {
    ...
    @Override
    public Response get(String url, String... cookies) throws Exception {
        URL obj = new URL(url);
        ...
        return new Response(response.toString(),conn.getHeaderFields().get("Set-Cookie"));
    }
